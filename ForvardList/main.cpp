...
void main()
{
	...
	int index;
	int value;
	cout << "Enter index of inserted element: "; cin >> index;
	cout << "Enter namber of inserted element: "; cin >> value;
	list.insert(index, value);
	list.print();

	cout << "Enter index of erased element: "; cin >> index;
	list.erase(index-1);
	list.print();
	...
	/*ForwardList list1 = { 3,5,8,13,21 };
	for (Iterator it = list1.getHead(); it != nullptr; ++it)
	{
		cout << *it << "\t";
	}
	cout << endl;*/
